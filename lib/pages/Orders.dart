...
class _OrdersState extends State<Orders> {
  ...
  final MaterialColor col = ("hie" == "hie") ? Colors.green : Colors.yellow;
  ...
  List<String> orderId = [
    "JVTORD20220628152827",
    "JVTORD20220628152758",
    "JVTORD20220628152332",
    "JVTORD20220627094626"
  ];
        ...
        SizedBox(
            ...
            child: Padding(
              ...
              child: Container(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsets.only(right: 12.0, top: 10, left: 12),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [Text('Orders', style: TextStyle(fontSize: 18))],
              ),
            ],
          ),
        ),
                    ...
                    children: [
                      ...
                      Flexible(
                          child: Text(status[index],
                              style: TextStyle(
                                  fontSize: 10,
                                  color: (status[index]) == "Payment Confirmed"
                                      ? Colors.green
                                      : Colors.yellow))),
                      Image.asset(
                        "assets/${icons[1]}",
